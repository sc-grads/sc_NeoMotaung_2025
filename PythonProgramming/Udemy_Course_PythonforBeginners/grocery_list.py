...
def is_an_option(text: str) -> None:
...
def main() -> None:
    ...
    while True:
        ...
        if user_input == "1":
            ...
            item_to_be_removed: str = input("What item would you like to remove? >>").lower()
            remove_item(item_to_be_removed, groceries)
        elif user_input == "3":
            display(groceries)
        elif user_input == "0":
